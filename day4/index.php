...
foreach($assignments as $assignment) {
    ...
    $overlap = doesRangeFullyContainRange($range1[0],$range1[1],$range2[0],$range2[1]) || doesRangeFullyContainRange($range2[0],$range2[1],$range1[0],$range1[1]);
...
/**
 * Determines if range 1 is fully contained within range 2
 */
function doesRangeFullyContainRange($range1Lower, $range1Upper, $range2Lower, $range2Upper) {
    return($range1Lower >= $range2Lower && $range1Upper <= $range2Upper);
}